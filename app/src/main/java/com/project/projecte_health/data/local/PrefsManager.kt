...
import com.project.projecte_health.data.local.PrefsManager.PreferencesKeys.USER_TYPE
...
import com.project.projecte_health.utils.Constants.USER_TYPE_PREF
...
//        private val dataStore = context.createDataStore(name = AUTO_AUTH_PREFS)
    ...
    private object PreferencesKeys {
        ...
        val USER_TYPE = stringPreferencesKey(USER_TYPE_PREF)
    }
    ...
    suspend fun saveUserType(userId: String) {
        dataStore.edit {
            it[USER_TYPE] = userId
        }
    }
